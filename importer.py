...
def main() -> None:
    ...
    parser.add_argument('path', metavar='PATH', nargs='?', default="import_file/default_import.txt", type=str,help='receives the path to the import file')
    ...
    if args.format:
        ...
        try:
            ...
            direct_export(info)
                ...
                info = input_text_file("import_file/default_import.txt")
                direct_export(info)
                print("Error while reading the path, used default path")
